    ...
    QB.chat.dialog.list(null, function(err, resDialogs) {
        if (err) {
            ...
            if (resDialogs.items.length === 0) {
                ...
                // Hide No chat message from chat screen.
                $("#noChatLbl").hide();
            }
...
function getDialogIcon(dialogType) {
    var groupPhoto = '<img src="img/ava-group.svg" width="30" height="30" class="round">';
    var privatPhoto = '<img src="img/ava-single.svg" width="30" height="30" class="round">';
